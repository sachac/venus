...
class HTMLSanitizerMixin(object):
    ...
    acceptable_elements = ['a', 'abbr', 'acronym', 'address', 'area',
        ...
        'figcaption', 'figure', 'footer', 'font', 'form', 'header', 'h1', 'h2', 'h3', 'h4',
        ...
        'tbody', 'td', 'textarea', 'time', 'tfoot', 'th', 'thead', 'tr', 'track', 'tt',
        'u', 'ul', 'var', 'video']
    ...
    acceptable_css_properties = ['azimuth', 'background-color',
        ...
        'font-family', 'font-size', 'font-style', 'font-variant', 'mix-blend-mode', 'font-weight',
